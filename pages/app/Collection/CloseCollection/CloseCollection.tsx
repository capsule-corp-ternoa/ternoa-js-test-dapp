...
import CloseCollectionBlock from 'components/blocks/Collection/CloseCollectionBlock/CloseCollectionBlock'
...
const CloseCollection: NextPage = () => {
  ...
  return (
    <>
      <CloseCollectionBlock signableCallback={signableCallback} />
      {unsignedTx && (
