...
import DelegateNFTBlock from 'components/blocks/NFT/DelegateNFTBlock/DelegateNFTBlock'
...
const DelegateNFT: NextPage = () => {
  ...
  return (
    <>
      <DelegateNFTBlock signableCallback={signableCallback} />
      {unsignedTx && (
