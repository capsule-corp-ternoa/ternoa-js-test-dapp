...
import AddNftTocollectionBlock from 'components/blocks/NFT/AddNFTToCollectionBlock/AddNFTToCollectionBlock'
...
const AddNftToCollection: NextPage = () => {
  ...
  return (
    <>
      <AddNftTocollectionBlock signableCallback={signableCallback} />
      {unsignedTx && (
