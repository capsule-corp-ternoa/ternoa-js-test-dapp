...
import SetNFTMarketplaceConfigurationBlock from 'components/blocks/SetNFTMarketplaceConfigurationBlock/SetNFTMarketplaceConfigurationBlock'
...
const SetNFTMarketplaceConfiguration: NextPage = () => {
  ...
  return (
    <>
      <SetNFTMarketplaceConfigurationBlock signableCallback={signableCallback} />
      {unsignedTx && (
