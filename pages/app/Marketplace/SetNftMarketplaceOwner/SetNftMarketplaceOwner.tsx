...
import SetNFTMarketplaceOwnerBlock from 'components/blocks/SetNFTMarketplaceOwnerBlock/SetNFTMarketplaceOwnerBlock'
...
const SetNFTMarketplaceOwner: NextPage = () => {
  ...
  return (
    <>
      <SetNFTMarketplaceOwnerBlock signableCallback={signableCallback} />
      {unsignedTx && (
...
export default SetNFTMarketplaceOwner
