...
import SetNFTMarketplaceKindBlock from 'components/blocks/SetNFTMarketplaceKindBlock/SetNFTMarketplaceKindBlock'
...
const SetNFTMarketplaceKind: NextPage = () => {
  ...
  return (
    <>
      <SetNFTMarketplaceKindBlock signableCallback={signableCallback} />
      {unsignedTx && (
...
export default SetNFTMarketplaceKind
