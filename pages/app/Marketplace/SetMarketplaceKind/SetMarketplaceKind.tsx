...
import SetMarketplaceKindBlock from 'components/blocks/Marketplace/SetMarketplaceKindBlock/SetMarketplaceKindBlock'
...
const SetMarketplaceKind: NextPage = () => {
  ...
  return (
    <>
      <SetMarketplaceKindBlock signableCallback={signableCallback} />
      {unsignedTx && (
...
export default SetMarketplaceKind
