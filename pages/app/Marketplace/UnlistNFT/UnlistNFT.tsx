...
import UnlistNFTBlock from 'components/blocks/Marketplace/UnlistNFTBlock/UnlistNFTBlock'
...
const UnlistNFT: NextPage = () => {
  ...
  return (
    <>
      <UnlistNFTBlock signableCallback={signableCallback} />
      {unsignedTx && (
