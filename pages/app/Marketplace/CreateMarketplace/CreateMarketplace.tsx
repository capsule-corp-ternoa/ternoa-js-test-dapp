...
import CreateMarketplaceBlock from 'components/blocks/Marketplace/CreateMarketplaceBlock/CreateMarketplaceBlock'
...
const CreateMarketplace: NextPage = () => {
  ...
  return (
    <>
      <CreateMarketplaceBlock signableCallback={signableCallback} />
      {unsignedTx && (
