...
import CreateNFTMarketplaceBlock from 'components/blocks/CreateNFTMarketplaceBlock/CreateNFTMarketplaceBlock'
...
const CreateNFTMarketplace: NextPage = () => {
  ...
  return (
    <>
      <CreateNFTMarketplaceBlock signableCallback={signableCallback} />
      {unsignedTx && (
...
export default CreateNFTMarketplace
